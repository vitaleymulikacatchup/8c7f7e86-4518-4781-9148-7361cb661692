...
export const metadata: Metadata = {
  title: "AutoShop - Premium Auto Services & Quality Vehicles",
  description: "Professional auto repair, maintenance, and quality pre-owned vehicles. Expert mechanics, fair pricing, trusted for 25+ years.",
  keywords: "auto shop, car repair, auto maintenance, used cars, vehicle service, mechanics",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "AutoShop - Your Trusted Auto Service Partner",
    description: "Premium auto repair, maintenance services, and quality pre-owned vehicles",
    type: "website",
    siteName: "AutoShop",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_363duVhy6gsyLA7AhWcnWC5yhmx/uploaded-1764239722224-q8rfbbp9.jpg",
        alt: "AutoShop - Premium Auto Services"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "AutoShop - Auto Services & Vehicles",
    description: "Professional auto repair and quality pre-owned vehicles",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_363duVhy6gsyLA7AhWcnWC5yhmx/uploaded-1764239722224-q8rfbbp9.jpg"]
  }
};
